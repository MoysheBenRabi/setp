<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyLocalProcessStates.ascx.cs" Inherits="CloudDaemonWeb.Controls.Processes.MyLocalProcessStates" %>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [LocalProcessStateId], [LocalProcessId], [OwnerId], [Created], [Modified], [Cpu], [Mem] FROM [LocalProcessState] WHERE ([OwnerId] = @OwnerId)" 
