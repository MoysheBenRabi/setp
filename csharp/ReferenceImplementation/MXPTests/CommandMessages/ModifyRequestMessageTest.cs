...
namespace MXPTests
{
    ...
    public class ModifyRequestTest
    {
        ...
        [Test]
        public void ModifyRequestMessageEncoding()
        {
            ...
            Assert.AreEqual(originalMessage.FrameDataSize(2), 98);
            ...
            ModifyRequestMessage decodedMessage = new ModifyRequestMessage();
        ...
        [Test]
        public void ModifyRequestMessageClear()
        {
            ModifyRequestMessage originalMessage = new ModifyRequestMessage();
            originalMessage.ObjectFragment.ObjectId = Guid.NewGuid();
            originalMessage.ObjectFragment.ObjectIndex = 1;
            ...
            ModifyRequestMessage emptyMessage = new ModifyRequestMessage();
