...
namespace MXPTests
{
    ...
    /// </summary>
    [TestFixture]
    public class EjectResponseMessageTest
    {
        [SetUp]
        public void SetUp()
        {
        ...
        [Test]
        public void EjectResponseMessageEncoding()
        {
            ...
            EjectResponseMessage decodedMessage = new EjectResponseMessage();
        ...
        [Test]
        public void EjectResponseMessageClear()
        {
            EjectResponseMessage originalMessage = new EjectResponseMessage();
            ...
            EjectResponseMessage emptyMessage = new EjectResponseMessage();
