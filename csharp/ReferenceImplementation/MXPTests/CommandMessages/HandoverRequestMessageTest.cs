...
namespace MXPTests
{
    ...
    /// </summary>
    [TestFixture]
    public class HandoverRequestTest
    {
        [SetUp]
        public void SetUp()
        {
        ...
        [Test]
        public void HandoverRequestMessageOneFrameEncoding()
        {
            ...
            HandoverRequestMessage decodedMessage = new HandoverRequestMessage();
        ...
        [Test]
        public void HandoverRequestMessageTwoFrameEncoding()
        {
            HandoverRequestMessage originalMessage = new HandoverRequestMessage();
            originalMessage.SourceBubbleId = Guid.NewGuid();
            originalMessage.TargetBubbleId = Guid.NewGuid();
        ...
        [Test]
        public void HandoverRequestMessageThreeFrameEncoding()
        {
            HandoverRequestMessage originalMessage = new HandoverRequestMessage();
            originalMessage.SourceBubbleId = Guid.NewGuid();
            originalMessage.TargetBubbleId = Guid.NewGuid();
        ...
        [Test]
        public void HandoverRequestMessageClear()
        {
            HandoverRequestMessage originalMessage = new HandoverRequestMessage();
            originalMessage.SourceBubbleId = Guid.NewGuid();
            originalMessage.TargetBubbleId = Guid.NewGuid();
            ...
            HandoverRequestMessage emptyMessage = new HandoverRequestMessage();
