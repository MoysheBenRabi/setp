...
MXP_MESSAGE_CHALLENGE_REQUEST = 4

class ChallengeRequest(Message): 

    def __init__(self):
        self.type_code = MXP_MESSAGE_CHALLENGE_REQUEST
    ...
    def clear(self):
        ...
        self.challenge_data_length = 0
        super(ChallengeRequest,self).clear()
    ...
    def __str__(self):
        return 'ChallengeRequest('+ str(self.challenge_datas) +')'
