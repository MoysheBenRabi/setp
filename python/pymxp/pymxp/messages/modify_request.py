...
MXP_MESSAGE_MODIFY_REQUEST = 16

class ModifyRequest(Message): 

    def __init__(self):
        self.type_code = MXP_MESSAGE_MODIFY_REQUEST
        self.object_header = ObjectFragment()

    def clear(self):
        self.object_header = ObjectFragment()
        super(ModifyRequest,self).clear()
    ...
    def __str__(self):
        return 'ModifyRequest('+ str(self.object_header) +')'
