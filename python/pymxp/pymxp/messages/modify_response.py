...
MXP_MESSAGE_MODIFY_RESPONSE = 17

class ModifyResponse(Message): 

    def __init__(self):
        self.type_code = MXP_MESSAGE_MODIFY_RESPONSE
        self.response_header = ResponseFragment()

    def clear(self):
        self.response_header = ResponseFragment()
        super(ModifyResponse,self).clear()
    ...
    def __str__(self):
        return 'ModifyResponse('+ str(self.response_header) +')'
