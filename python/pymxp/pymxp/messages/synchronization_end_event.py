...
MXP_MESSAGE_SYNCHRONIZATION_END_EVENT = 71

class SynchronizationEndEvent(Message): 

    def __init__(self):
        self.type_code = MXP_MESSAGE_SYNCHRONIZATION_END_EVENT

    def clear(self):
        super(SynchronizationEndEvent,self).clear()
