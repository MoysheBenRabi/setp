...
/**
 * An bubble detach response message, as specified by the MXP protocol.
 */
public class DetachResponse extends Message {
    /**
     * The response header.
     */
    ...
    public DetachResponse() {
        super(Message.Type.DETACH_RESPONSE);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DetachResponse)) {
            return false;
        }
        DetachResponse other = (DetachResponse) obj;
