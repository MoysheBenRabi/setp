...
/**
 * An bubble handover event message, where an object would be handed over
 * from one bubble to another, as specified by the MXP protocol.
 * Same as HandoverRequest
 */
public class HandoverEvent extends Message {
    /**
    ...
    public HandoverEvent() {
        super(Message.Type.HANDOVER_EVENT);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HandoverEvent)) {
            return false;
        }
        HandoverEvent other = (HandoverEvent) obj;
        if (object == null) {
