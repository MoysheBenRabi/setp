...
/**
 * An examination response message, as specified by the MXP protocol.
 */
public class ExamineResponse extends Message {
    /**
     * The response header.
     */
    ...
    /**
     * The object that was requested to be examined.
     */
    ...
    public ExamineResponse() {
        super(Message.Type.EXAMINE_RESPONSE);
    }
    ...
    @Override
    public int size() {
        return responseHeader == null || object == null
             ? -1
             : responseHeader.size() + object.size();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExamineResponse)) {
            return false;
        }
        ExamineResponse other = (ExamineResponse) obj;
        if (object == null) {
