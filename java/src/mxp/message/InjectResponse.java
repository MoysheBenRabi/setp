...
/**
 * An inject response message, as specified by the MXP protocol.
 * This message only contains a response fragment.
 */
public class InjectResponse extends Message {
    /**
     * The response header.
     */
    ...
    public InjectResponse() {
        super(Message.Type.INJECT_RESPONSE);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof InjectResponse)) {
            return false;
        }
        InjectResponse other = (InjectResponse) obj;
