...
/**
 * A disappearance event message, as specified by the MXP protocol.
 */
public class DisappearanceEvent extends Message {
    /**
     ...
     * Constructor.
     */
    public DisappearanceEvent() {
        super(Message.Type.DISAPPEARANCE_EVENT);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DisappearanceEvent)) {
            return false;
        }
        DisappearanceEvent other = (DisappearanceEvent) obj;
