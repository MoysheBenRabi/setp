...
/**
 * An bubble handover response message, as specified by the MXP protocol.
 */
public class HandoverResponse extends Message {
    /**
     * The response header.
     */
    ...
    public HandoverResponse() {
        super(Message.Type.HANDOVER_RESPONSE);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HandoverResponse)) {
            return false;
        }
        HandoverResponse other = (HandoverResponse) obj;
