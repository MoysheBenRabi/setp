...
/**
 * An object eject request message, as specified by the MXP protocol.
 */
public class EjectRequest extends Message {
    /**
     * The object about to be ejected.
     */
     ...
     */
    public EjectRequest() {
        super(Message.Type.EJECT_REQUEST);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EjectRequest)) {
            return false;
        }
        EjectRequest other = (EjectRequest) obj;
        if (objectId == null) {
