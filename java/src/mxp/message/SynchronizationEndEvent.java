...
/**
 * A synchronization end event message, as specified by the MXP protocol.
 */
public class SynchronizationEndEvent extends Message {
    /**
     * Constructor.
     */
    public SynchronizationEndEvent() {
        super(Message.Type.SYNCHRONIZATION_END_EVENT);
    }
