...
/**
 * An eject response message, as specified by the MXP protocol.
 * This message only contains a response fragment.
 */
public class EjectResponse extends Message {
    /**
     * The response header.
     */
     ...
     * Constructor.
     */
    public EjectResponse() {
        super(Message.Type.EJECT_RESPONSE);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EjectResponse)) {
            return false;
        }
        EjectResponse other = (EjectResponse) obj;
