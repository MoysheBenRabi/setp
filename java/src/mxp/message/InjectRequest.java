...
/**
 * An object inject request message, as specified by the MXP protocol.
 */
public class InjectRequest extends Message {
    /**
     * The object about to be injected.
     */
    ...
    public InjectRequest() {
        super(Message.Type.INJECT_REQUEST);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof InjectRequest)) {
            return false;
        }
        InjectRequest other = (InjectRequest) obj;
        if (object == null) {
