...
/**
 * A Throttle message, as specified by the MXP protocol.
 * This message specifies the maximum transfer rate preferred.
 */
public class Throttle extends Message {
    /**
     * Maximum transfer rate preferred, in bytes / second.
     */
     ...
     */
    public Throttle() {
        super(Message.Type.THROTTLE);
    }

    /**
     * @return the maxTransferRate
     */
    ...
    /**
     * @param newMaxTransferRate the maxTransferRate to set
     */
    public void setMaxTransferRate(int newMaxTransferRate) {
        maxTransferRate = newMaxTransferRate;
    }
    ...
    public int serialize(SerializationOutputStream out) throws IOException {
        ...
        counter += out.put(maxTransferRate);
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof Throttle)) {
            return false;
        }

        Throttle throttle = (Throttle) other;

        return maxTransferRate == throttle.maxTransferRate;
    }
}
