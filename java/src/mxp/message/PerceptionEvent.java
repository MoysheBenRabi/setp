...
/**
 * A perception event message, as specified by the MXP protocol.
 */
public class PerceptionEvent extends Message {
    /**
    ...
    public PerceptionEvent() {
        super(Message.Type.PERCEPTION_EVENT);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PerceptionEvent)) {
            return false;
        }
