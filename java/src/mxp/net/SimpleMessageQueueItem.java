...
/**
 * Class to represent a pair of a message, and a flag indicating
 * it's a guaranteed message or not.
 */
public class SimpleMessageQueueItem implements MessageQueueItem {
    /**
     * The message.
     */
