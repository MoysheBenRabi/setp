#ifndef GENERATE_MESSAGES_H
#define GENERATE_MESSAGES_H
...
boost::shared_ptr<mxp::message::join_rq>         generate_join_rq();
boost::shared_ptr<mxp::message::inject_rq>       generate_inject_rq();
