#ifndef MXP_MESSAGE_INJECT_RQ
#define MXP_MESSAGE_INJECT_RQ
 ...
 */
class inject_rq : public message {
public:
    ...
    /*! Copy constructor.
        ...
        \param inj_rq the object to base this copy on.
    */
    inject_rq(const inject_rq & inj_rq) : message(INJECT_RQ) {
        object_header = inj_rq.object_header;
    }

    /*! Assignment operator.

        \param inj_rq the object to base this object on.
        \return a reference to this object, after the assignemt has been made.
    */
    inject_rq& operator=(const inject_rq & inj_rq) {
        if (this == &inj_rq) {
            return *this;
        }
        object_header = inj_rq.object_header;
    ...
    */
    virtual bool equals(const message & other) const {
       return (this == &other) || 
              ...
              (object_header == ((inject_rq &) other).object_header));
    }
...
/*! Write a human-readable representation of a message to an output stream.
    ...
    \param inj_rq the message to write.
    \return the output stream after the message has been written to it.
*/
inline
std::ostream& operator<<(std::ostream &os, const inject_rq & inj_rq) {
    os << "inject_rq[type: " << inj_rq.get_type();
    os << ",object_header=";
    os << inj_rq.object_header;
    os << "]";
    return os;
}
